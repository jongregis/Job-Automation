...
class Item(object):
    ...
    def amount(self):
        ...
        elif self.unit_price == 4000 and self.percentage == '22.5%':
            return Decimal(str(3100))
        ...
        elif self.percentage == '30%' and self.unit_price == 3250:
            return Decimal(str(2275))
        # CA/PP
        elif self.percentage == '25%' and self.unit_price == 4250:
            return Decimal(str(3187.50))
        elif self.percentage == '25%' and self.unit_price == 3000:
            return Decimal(str(2250))
        elif self.percentage == '25%' and self.unit_price == 3500:
            return Decimal(str(2625.50))
        elif self.percentage == '25%' and self.unit_price == 3799:
            return Decimal(str(2849.25))
        ...
        elif self.unit_price == 6499 and self.percentage == '':
            return Decimal(str(5499))
        # ed4 wellness coaching
        elif self.unit_price == 3250 and self.percentage == '22.5%':
            return Decimal(str(2518.75))
        elif self.unit_price == 3250 and self.percentage == '25%':
            return Decimal(str(2437.50))
        # TAMU ED4
        elif self.unit_price == 3999 and self.percentage == '':
            return Decimal(str(2999))
        elif self.unit_price == 3750 and self.percentage == '':
            return Decimal(str(2750))
        # ECDC
